...
class DisplayAlbumsSongs {
    ...
    public static function displayAlbums(array $artistsAlbums, SongsModel $songs, int $playId): string
    {
        $albums = '';
        foreach ($artistsAlbums as $singleAlbum) {
            ...
            foreach ($songsInAlbum as $songInAlbum) {
                ...
                $albums .=  DisplayPlayButtonService::playCount($playId, $songInAlbum->getSongId());
