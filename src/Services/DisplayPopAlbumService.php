...
class DisplayPopAlbumService{
    public static function displayPopularAlbums(string $albumName, string $artworkURL, string $albumArtist, int $artistId): string
    {
        return " <div class='border-b border-slate-500 pb-5 mb-3 flex justify-between items-center'>
                            ...
                            <a href='artist.php?id=$artistId' class='hover:text-slate-500 hover:cursor-pointer'>
