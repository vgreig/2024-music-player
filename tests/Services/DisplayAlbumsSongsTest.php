        ...
        $expected = "                        <div class='rounded p-3 bg-cyan-950'>
                    ...
                    <div class='mx-3 mb-3 flex justify-between items-center'>
                        ...
                        <div class='flex items-center justify-between w-24'>
                            <span class='text-slate-500'>3:45</span><a href='?id=2&playSong=0' class='hover:text-slate-500 hover:cursor-pointer'>
                       ...
                       </a><a href='artist.php?id=2&songId=0' class='hover:text-slate-500 hover:cursor-pointer'>
                            ...
                            </svg></a><span class='text-slate-500'></span>
                        </div>
                    </div></div>";
